...
while True:
    print("Enter 1 to display the available books"); print("Enter 2 to request for a books"); print("Enter 3 to return a book"); print("Enter 4 to exit")
    userchoice = int(input())
    if userchoice is 1:
         library.displayAvailableBooks()
    elif userchoice is 2:
         requestBook = customer.requestBook()
         print("customer request object value:",requestBook)
         library.lendBook(requestBook)
    elif userchoice is 3:
         returnBook = customer.returnBook()
         print("Customer return object value:",returnBook)
